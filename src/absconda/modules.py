...
def _load_module_template() -> str:
    """Load module template from package resources."""
    template_pkg = files("absconda._templates.modules")
    template_file = template_pkg / "tcl.j2"
...
def generate_module(config: ModuleConfig) -> Path:
    ...
    template_str = _load_module_template()
